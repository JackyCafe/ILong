...
from app.views import UserInfoViewSet, CurrencyInfoViewSet, PlantInfoViewSet, IrrIgationInfoViewSet, EcologyInfoViewSet, \
    PlantingHistoryViewSet, QuestionnaireViewSet, DailyViewSet, OtherViewSet
